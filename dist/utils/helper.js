...
export const scheduleTasks = async (taskId, relatedUserId, taskRepeatsOn, createdOn) => {
    try {
        ...
        for (let i = 0; i < daysToSchedule; i++) {
            ...
            if (taskRepeatsOn.includes(currentDay)) {
                ...
                const query = await pool.query(`INSERT INTO task_schedule (scheduleId, relatedTaskId, relatedUserId, scheduledOn, createdOn) VALUES (?, ?, ?, ?, ?)`, [uuid(), taskId, relatedUserId, scheduledOn, createdOn]);
